...
const meta = {
  title: 'Components/BrightnessSlider',
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
/**
 * Inverted slider direction: brightness 100% on left, 0% on right.
 */
    ...
    <div style={{ width: 300 }}>
      <ColorWheel.Root value={color} onValueChange={setColor}>
        ...
        <div style={{ marginBottom: 12 }}>
          ...
          <ColorWheel.BrightnessSlider trackSize={20} thumbSize={24} />
        </div>
        <div>
          <p style={{ fontSize: 12, color: '#666', marginBottom: 4 }}>
            Slim (8px track, 12px thumb):
          </p>
          <ColorWheel.BrightnessSlider trackSize={8} thumbSize={12} />
        </div>
      </ColorWheel.Root>
      <p style={{ marginTop: 16, fontFamily: 'monospace' }}>Selected: {color}</p>
    </div>
...
/**
 * Full HSV control with HueSlider, SaturationSlider, and BrightnessSlider.
 */
export const FullHSVControl: StoryFn = () => {
